...
class BookingController extends Controller
{
    public function store(StoreBookingRequest $request)
    {
        ...
        // 7. Validate that slot is not already booked (One booking per slot rule)
        ...
        // 8. Create booking (Auto-confirmed for phase 1)
        ...
        // 9. Mark slot as unavailable to definitively prevent double hooking
